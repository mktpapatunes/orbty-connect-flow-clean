...
const CampaignView = () => {
  ...
  // quando entra em modo busca, default: mostrar todos; usuário pode ligar onlyTop
  useEffect(() => {
  ...
  const timelineRenderItems: RenderItem[] = useMemo(() => {
    ...
    // ✅ Quando buscando e onlyTop ligado, mostramos só os 3 primeiros
                            ...
                            {expanded ? (
                              <div className="space-y-2">
                                {events.map((ev) => {
                                  ...
                                  return (
                                    <div key={ev.event_id} className="flex items-center justify-between gap-3 rounded-xl border border-border/50 bg-card/60 px-3 py-2">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {events.slice(0, 3).map((ev) => {
                                  ...
                                  return (
                                    <span
                                      key={ev.event_id}
                                      className="text-[10px] px-2 py-1 rounded-full border border-border/50 bg-card/60 text-muted-foreground"
