...
const ContractorDashboard = () => {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      icon: CircleHelp,
      route: "/ajuda", // se não existir, troque por "/perfil" ou remova este item
    },
  ];
    ...
    <MobileLayout title="Início" navType="contractor">
      <div className="px-6 py-6 space-y-6">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <div className="mt-2 flex items-center gap-2 flex-wrap">
                ...
                {user?.email ? <span className="text-[10px] text-muted-foreground">{user.email}</span> : null}
              </div>
        ...
        <motion.div
          ...
          className="space-y-3"
        >
          <p className="text-xs text-muted-foreground uppercase tracking-widest font-medium">O que você ganha aqui</p>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            entregas e status) fica dentro de <span className="text-foreground font-medium">Minhas campanhas</span>.
          </p>
        </motion.div>
