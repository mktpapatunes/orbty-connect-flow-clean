...
import { User, Mail, Phone, Instagram, ChevronRight, Lock, Users, Loader2 } from "lucide-react";
...
const InfluencerRegistration = () => {
  ...
  const fields = [
    { key: "name", label: "Nome completo", icon: User, placeholder: "Seu nome", type: "text" },
